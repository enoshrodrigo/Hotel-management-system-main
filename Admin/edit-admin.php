    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" style="overflow: auto;">
            <div class="row" id="row">
                <h3 class="text-dark mb-4">Room-Admin</h3>
            </div>
            <div class="card shadow">
                <div class="card-header py-3" id="addcustomer"> 
                    <p class="text-primary m-0 fw-bold" id="addcustomer">Admin Info
                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" style="float:right;" id="addcustomer">Admin</a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6">  `
                                ...
                                if($result){
                                  ...
                                  <div> Re enter password: <input type="password" name="passwordCheck" class="form-control" id="passwordCheck" required >
 ...
 //check password match or not if not match show error message and disable submit button
    ...
    $(document).ready(function(){
        $('#passwordCheck').keyup(function(){
            ...
            if(password != passwordCheck){
                ...
                $('#adminubmit').attr('disabled',true);
            }else{
                $('#message').html('Password Matching').css('color','green');
                $('#adminubmit').attr('disabled',false);
            }
        });
    });
    ...
    <footer class="bg-white sticky-footer">
        <div class="container my-auto">
            <div class="text-center my-auto copyright"><span>Copyright © Room-Admin 2023</span></div>
        </div>
    </footer>
