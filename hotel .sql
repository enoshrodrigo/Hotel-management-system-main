...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2023 at 08:07 PM
...
('19902234686V', 'Kasun', 'Perera', '0778946566', 'kasun@gmail.com', '2005-06-01', '2023-04-09 18:09:34', '', '', 10),
...
(25, 'Chicken  ', 10, 5050, 'g', 1200, NULL, '', '2023-05-27 17:06:45', 12000),
(27, 'Rice  ', 10, 4500, 'g', 1000, NULL, '', '2023-05-27 17:15:53', 10000),
...
(1, 'kitchen', '202cb962ac59075b964b07152d234b70');
...
(1, 1, 1, NULL, 0, NULL, 3000, 1, 'single room', 1, 1, 0, 0, 1, '2023-06-04 11:31:36', '2023-06-08 15:01:00', '19902234686V'),
...
(15, 3, 4, NULL, 2, NULL, 6000, 1, NULL, 1, 1, 1, 0, 0, '2023-05-31 04:49:05', '2023-06-03 08:19:00', '19902234686V'),
...
--
ALTER TABLE `bookedrooms`
  MODIFY `bookedid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `history`
  MODIFY `historyid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
