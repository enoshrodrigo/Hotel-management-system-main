            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" style="float:left;" onclick="deleteRecipe(' . $row['recipe_id'] . ')">Delete</button>
...
//delete recipe from database
                        ...
                        //click recipe id
                        function clickRecipeID(recipe_id) {
                            document.getElementById(recipe_id).click();
                        }
                    </script>
